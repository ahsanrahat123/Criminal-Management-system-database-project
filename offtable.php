...
<table class = "table table-responsive-md    table-striped table-dark table-hover">
   ...
   <h5 style="MARGIN-LEFT:38.5%;color:white;">OFFICER INFORMATION</h5>
<BR method="post"> 
    ...
    print " <th>OFFICER ID</th> <th>NAME</th>    <th>RANK</th>  <th  >JOINING DATE</th>    <th>PREVIOUS STATION</th> <th>CONTACT NUMBER</th>    <th>STATION ID</th>";
