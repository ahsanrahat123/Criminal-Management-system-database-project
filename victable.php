...
<table class = "table table-responsive-md    table-striped table-dark table-hover">
   ...
   <h5 style="MARGIN-LEFT:38.5%;color:white;">VICTIM INFORMATION</h5>
<BR method="post"> 
    ...
    print " <th>VICTIM ID</th> <th> NAME</th>    <th>POSTAL CODE</th>  <th  >HOUSE NO</th>    <th>STREET</th> <th>VICTIM NO</th>";
